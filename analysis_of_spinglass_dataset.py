...
np.savez(f'data/datasets/dataset_fullyconnected_spinglass_ndata_{ndata}_nsites_{n_sites}_sigma_{sigma:.1f}',fs=fs,zz_matrices=zz_matrices,energies=energies,couplings=couplingss,fs_density=fs_density)
